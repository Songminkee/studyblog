...
- MAE는 $$l_1$$ norm 이라고도 부르며 $$||\centerdot||_2$$로 표기하고 도시의 구획이 직각으로 나뉘어 있을 때 이 도시의 두 지점 사이의 거리를 측정하는 것과 같아 맨해튼 노름(Manhattan norm)이라고도 한다.
...
<img src="{{'assets/picture/head_method_resul.jpg' | relative_url}}">
...
<img src="{{'assets/picture/describe_method_resul.jpg' | relative_url}}">
...
<img src="{{'assets/picture/histogram_method_result.jpg' | relative_url}}">
